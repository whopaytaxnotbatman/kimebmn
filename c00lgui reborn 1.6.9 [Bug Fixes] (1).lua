...
local title = Instance.new("TextLabel")
	...
	title.Text = "0hi0gui Fluxus skidded by Laugh_1"
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Bun Bun GUI"
	button.Position = UDim2.new(0.5,3,0,198)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Bun Bun GUI"
	button.TextColor3 = whit
	button.MouseButton1Down:connect(function()
		-- Gui to Lua
-- Version: 3.
...
local flymi = Instance.new("TextButton")
...
Name.Name = "Name"
Name.Parent = Frame
Name.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
Name.Size = UDim2.new(0, 378, 0, 25)
Name.Font = Enum.Font.GothamBold
Name.Text = "Bun Bun Gui"
...
Credits.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
Credits.Position = UDim2.new(0, 0, 0.912, 0)
Credits.Size = UDim2.new(0, 378, 0, 22)
Credits.Font = Enum.Font.GothamBold
Credits.Text = "By Laughability_2"
...
e1x1x1x1Message.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
e1x1x1x1Message.Text = "Bun Bun Message"
...
e1x1x1x1Message.MouseButton1Down:connect(function()
	while true do
		...
		msg.Text = "Bun Bun Girl: I HAVE RETURNED FOR THE 10TH GOD DANG TIME"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Hint")
		msg.Parent = game.Workspace
		msg.Text = "Bun Bun Girl: NOW YOU WILL ALL DIE IN MY BALLZ"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Hint")
		msg.Parent = game.Workspace
		msg.Text = "Bun Bun Girl: I WILL DESTROY ALL UR BALLZ"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Hint")
		msg.Parent = game.Workspace
		msg.Text = "Bun Bun Girl: YOU WILL NOT LIVE THROUGH MY CRINGINESS LEVEL"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Hint")
		msg.Parent = game.Workspace
		msg.Text = "Bun Bun Girl: I MIGHT AS WELL TURN U GOOFY AHH"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Hint")
		msg.Parent = game.Workspace
		msg.Text = "Bun Bun Girl: AND THEN THOSE GOOFY AHHS WILL PRETEND TO BE HAKRS! LEELLELEELELLE"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Hint")
		msg.Parent = game.Workspace
		msg.Text = "Bun Bun Girl: YOU CAN'T STOP MY BALLZ FROM REACHING U"
		wait(6)
		msg:remove()
	end
end)
...
e1x1x1x1Music.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
e1x1x1x1Laugh.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
e1x1x1x1Laugh.Text = "1x1x1x1/Bun Bun Laugh"
...
DayToNight.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
flymi.Name = "flymi"
flymi.Parent = Frame
flymi.BackgroundColor3 = Color3.fromRGB(255,105,180)
flymi.Position = UDim2.new(0.388888896, 0, 0.648000002, 0)
flymi.Size = UDim2.new(0, 89, 0, 31)
flymi.Font = Enum.Font.GothamBold
flymi.Text = "Fly"
flymi.TextColor3 =Color3.fromRGB(0, 0, 0)
flymi.TextScaled = true
flymi.TextSize = 14.000
flymi.TextWrapped = true
flymi.MouseButton1Down:connect(function()
...
Disc0.Name = "Disc0"
Disc0.Parent = Frame
Disc0.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
e2006Theme.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
e2006Theme.Text = "when the bun bun is sus"
...
e2006Theme.MouseButton1Down:connect(function()
	...
	s.Name = "Sound"
	s.SoundId = "http://www.roblox.com/asset/?id=6943949840"
	s.Volume = 1
	s.Pitch = 3
	s.Looped = true
	s.archivable = false
...
ForceField.BackgroundColor3 = Color3.fromRGB(255, 105, 180)
...
button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Gothic (npc game)"
	button.Position = UDim2.new(0.5,3,0,33)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Gothic (npc game)"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Music ID"].TextBox.Text = 9634998326	
	end)
--
button = Instance.new("TextButton")
	button.Parent = pmi
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Talking Ben"
	button.Position = UDim2.new(0,0,0,33)
	button.Size = UDim2.new(0.5,0,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Talking Ben"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 8888407111	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
